...
/**
 * 1. Рассчитываем сумму всех продаж.
 */
public class StatsService {
    ...
    /**
     * 2. Рассчитываем среднюю сумму продаж в месяц.
     */
    ...
    /**
     * 3. Рассчитываем номер месяца, в котором был пик продаж
    ...
    /**
     * 4. Рассчитываем номер месяца, в котором был минимум продаж
    ...
    /**
     * 5. Рассчитываем количество месяцев, в которых продажи были ниже среднего
     * (см. п.2)
     */
    ...
    /**
     * 6. Рассчитываем количество месяцев, в которых продажи были выше среднего
     * (см. п.2)
     */
